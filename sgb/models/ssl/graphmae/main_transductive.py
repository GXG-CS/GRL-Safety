...
def pretrain(model, graph, feat, optimizer, max_epoch, device, scheduler, num_classes, lr_f, weight_decay_f, max_epoch_f, linear_prob, logger=None):
    ...
    for epoch in epoch_iter:
        ...
        # Disabled mid-training eval: eval is moved to a separate downstream script
        # if (epoch + 1) % 200 == 0:
...
def main(args):
    ...
    for i, seed in enumerate(seeds):
        ...
        # Disabled post-training eval: eval is moved to a separate downstream script
