...
def get_ft_loader(data, split, params):
    ...
    if task == "node":
        ...
        # Single-relation link datasets (e.g. protein_hs) carry only positive
        # edges; without negative sampling, eval AUC is undefined. Inject 1:1
        # negatives so the binary classifier sees both classes.
