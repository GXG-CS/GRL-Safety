...
def get_args_pretrain():
    ...
    parser.add_argument("--save_dir", "--ckpt_dir", type=str, default=None,
                        help="Override checkpoint save directory")
    parser.add_argument("--save_every", type=int, default=0,
                        help="Save intermediate encoder_{epoch}.pt every N epochs. "
                             "0 disables intermediate saves (only final encoder.pt).")
    parser.add_argument("--resume", action="store_true",
                        help="Resume from <save_dir>/state_latest.pt if present.")
...
def get_args_finetune():
    ...
    parser.add_argument("--ckpt_dir", type=str, default=None,
                        help="Direct path to ckpt directory with encoder.pt")
