...
citation_datasets = ['arxiv', 'cora', 'citeseer', 'pubmed', 'arxiv23', 'dblp', 'wikics', 'arxivyear']
ecommerce_datasets = ['bookhis', 'bookchild', 'elecomp', 'elephoto', 'sportsfit', 'amazonratings', 'products', 'tolokers']
...
kg_datasets = ['WN18RR', 'FB15K237', 'codex_s', 'codex_m', 'codex_l', 'NELL995', 'GDELT', 'ICEWS1819',
               'goodreads', 'ml1m', 'ml1m_cls', 'protein_hs']  # new link datasets mapped to 'edge' task
