"""V2: subgraph-ablation interpretation for UniGraph2 (DGL-internal)."""
import argparse
...
from sgb.models.gfm.unigraph2.run_interpretation import (
    build_model, FTModel, load_dataset, train_ft)
...
def main():
    ...
    print(f"[UniGraph2 V2-INTERP] N={N} d={input_size} C={num_classes}")
    ...
    for rs in RUN_SEEDS[:n_seeds]:
        ...
        print(f"[UniGraph2 V2-INTERP] seed={rs} clean_acc={acc:.2f}")
        ...
        for explainer in explainers:
            ...
            for tk in topk_list:
                ...
                print(f"[INTERP_NODE_V2_RAW] method=UniGraph2 dataset={args.dataset} "
    ...
    for (explainer, tk), d in agg.items():
        ...
        print(f"[INTERP_NODE_V2_AGG] method=UniGraph2 dataset={args.dataset} "
