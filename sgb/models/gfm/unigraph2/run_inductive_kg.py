"""UniGraph2 inductive KG link-prediction on FB15K237/WN18RR."""
import argparse
...
class _KGModel(nn.Module):
    ...
    def encode(self, x, edge_index):
        ...
        return self.pre_model(g, {"text": x}, spd_matrix=None, return_embeddings=True)
...
def _builder(in_channels, device):
    ...
    pre_model.load_state_dict(_CKPT, strict=False)
...
def main():
    ...
    run_inductive_kg(
        method_tag="UniGraph2_FT", dataset=_ARGS.dataset,
